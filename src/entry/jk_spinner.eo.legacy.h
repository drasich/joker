#ifndef _JK_SPINNER_EO_LEGACY_H_
#define _JK_SPINNER_EO_LEGACY_H_
 ...
 * @ingroup Jk_Spinner
 */
EAPI void jk_spinner_wrap_set(Jk_Spinner *obj, Eina_Bool wrap);
 ...
 * @ingroup Jk_Spinner
 */
EAPI Eina_Bool jk_spinner_wrap_get(const Jk_Spinner *obj);
 ...
 * @ingroup Jk_Spinner
 */
EAPI void jk_spinner_round_set(Jk_Spinner *obj, int rnd);
 ...
 * @ingroup Jk_Spinner
 */
EAPI int jk_spinner_round_get(const Jk_Spinner *obj);
 ...
 * @ingroup Jk_Spinner
 */
EAPI void jk_spinner_editable_set(Jk_Spinner *obj, Eina_Bool editable);
 ...
 * @ingroup Jk_Spinner
 */
EAPI Eina_Bool jk_spinner_editable_get(const Jk_Spinner *obj);
 ...
 * @ingroup Jk_Spinner
 */
EAPI void jk_spinner_base_set(Jk_Spinner *obj, double base);
 ...
 * @ingroup Jk_Spinner
 */
EAPI double jk_spinner_base_get(const Jk_Spinner *obj);
 ...
 * @ingroup Jk_Spinner
 */
EAPI void jk_spinner_label_format_set(Jk_Spinner *obj, const char *fmt);
 ...
 * @ingroup Jk_Spinner
 */
EAPI const char *jk_spinner_label_format_get(const Jk_Spinner *obj);
 ...
 * @ingroup Jk_Spinner
 */
EAPI void jk_spinner_special_value_add(Jk_Spinner *obj, double value, const char *label);
