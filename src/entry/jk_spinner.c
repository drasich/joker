...
#define WRN(...)      EINA_LOG_DOM_WARN(1, __VA_ARGS__)
...
#define JK_SPINNER_DATA_GET(o, sd) \
  Jk_Spinner_Data * sd = eo_data_scope_get(o, JK_SPINNER_CLASS)
...
#define JK_SPINNER_CHECK(obj)                              \
  if (EINA_UNLIKELY(!eo_isa((obj), JK_SPINNER_CLASS))) \
    return
...
static const Evas_Smart_Cb_Description _smart_callbacks[] = {
   ...
   {SIG_DRAG_START, ""},
   {SIG_DRAG_STOP, ""},
   {"language,changed", ""}, /**< handled by elm_widget */
   {"access,changed", ""}, /**< handled by elm_widget */
   {"focused", ""}, /**< handled by elm_layout */
   {"unfocused", ""}, /**< handled by elm_layout */
   {NULL, NULL}
};
...
static void
_entry_show(Jk_Spinner_Data *sd)
{
   Eina_List *l;
...
_elm_spinner_elm_widget_event(Eo *obj, Jk_Spinner_Data *sd EINA_UNUSED, Evas_Object *src EINA_UNUSED, Evas_Callback_Type type, void *event_info)
{
...
_jk_spinner_eo_base_constructor(Eo *obj, Jk_Spinner_Data *pd)
{
  printf("constructorrrrrrrrrrrrr************************************* begin : %p \n", obj);
  ...
  printf("constructorrrrrrrrrrrrr------------------------------------ end : %p \n", obj);
...
EOLIAN static void
_jk_spinner_efl_canvas_group_group_del(Eo *obj, Jk_Spinner_Data *sd)
{
   Elm_Spinner_Special_Value *sv;
...
_jk_spinner_elm_widget_theme_apply(Eo *obj, Jk_Spinner_Data *sd)
{
...
EOLIAN static Eina_Bool
_jk_spinner_elm_widget_focus_next(Eo *obj, Jk_Spinner_Data *_pd, Elm_Focus_Direction dir, Efl_Canvas_Object **next, Elm_Widget_Item **next_item)
{
   Evas_Object *ao;
   Eina_List *items = NULL;

   JK_SPINNER_CHECK(obj) EINA_FALSE;
...
EOLIAN static Eina_Bool
_jk_spinner_elm_widget_focus_direction(Eo *obj, Jk_Spinner_Data *_pd, const Efl_Canvas_Object *base, double degree, Efl_Canvas_Object **direction, Elm_Widget_Item **direction_item, double *weight)
{
   Eina_Bool ret;
   Eina_List *items = NULL;
...
EOLIAN static Eina_Bool
_jk_spinner_elm_widget_on_focus(Eo *obj, Jk_Spinner_Data *sd, Elm_Widget_Item *item)
{
...
_access_info_cb(void *data, Evas_Object *obj EINA_UNUSED)
{
   ...
   JK_SPINNER_DATA_GET(spinner, sd);
...
EOLIAN static void
_jk_spinner_efl_ui_spin_min_max_set(Eo *obj, Jk_Spinner_Data *sd, double min, double max)
{
...
EOLIAN static void
_jk_spinner_efl_ui_spin_min_max_get(Eo *obj, Jk_Spinner_Data *sd, double *min, double *max)
{
...
EOLIAN static void
_jk_spinner_efl_ui_spin_step_set(Eo *obj, Jk_Spinner_Data *sd, double step)
{
...
_jk_spinner_efl_ui_spin_step_get(Eo *obj, Jk_Spinner_Data *sd)
{
...
EOLIAN static void
_jk_spinner_efl_ui_spin_value_set(Eo *obj, Jk_Spinner_Data *sd, double val)
{
...
EOLIAN static double
_jk_spinner_efl_ui_spin_value_get(Eo *obj, Jk_Spinner_Data *sd)
{
   return sd->val;
}
...
EOLIAN static void
_jk_spinner_label_format_set(Eo *obj, Jk_Spinner_Data *sd, const char *fmt)
{
...
EOLIAN static void
_jk_spinner_class_constructor(Eo_Class *klass)
{
...
jk_spinner_add(Evas_Object *parent)
{
   ...
   printf("jk_spinner_add inside, obj : %p \n", obj);
   return obj;
}
